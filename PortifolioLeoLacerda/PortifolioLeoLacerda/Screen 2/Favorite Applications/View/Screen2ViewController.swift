...
extension Screen2ViewController: ApplicationsTableViewCellProtocol{
    func pressedCell(app: Application) {
        let vc: AppPageViewController? = UIStoryboard(name: "AppPageViewController", bundle: nil).instantiateViewController(withIdentifier: "AppPageViewController") as? AppPageViewController
        vc?.configAppPage(application: app)
